...
function SponsorDetail({ sponsor, rate, displayCurrency, onBack, onEdit, onDelete, onAddPublication, onAddSlotPublication, onAddTransaction, onEditPublication, onEditTransaction }: { sponsor: Sponsor; rate: Rate; displayCurrency: Currency; onBack: () => void; onEdit: () => void; onDelete: () => void; onAddPublication: () => void; onAddSlotPublication: (slot: Slot) => void; onAddTransaction: () => void; onEditPublication: (item: Publication) => void; onEditTransaction: (item: Transaction) => void }) {
